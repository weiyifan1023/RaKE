...
def apply_ft_to_model(
    ...
    **kwargs: Any,
    ...
    if perspective == "entity":
        ...
        deltas = execute_rel_ft(model, tok, requests, hparams)
...
def execute_rel_ft(
    ...
    **kwargs: Any,
    ...
    # Define inputs
    texts = [r["add_rel_prompt"].format(r["subject"]) for r in requests]  # 可以添加 rm_rel_prompt 和 target:None
    targets = [r["relation"]["strs"][0] for r in requests]
